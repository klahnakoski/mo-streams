...
setup(
    ...
    extras_require={"tests":["mo-files","mo-logs","zstandard","boto3","moto","pandas"]},
    include_package_data=True,
    install_requires=["mo-dots==9.279.22339","mo-files==6.281.22341","mo-future==6.265.22338","mo-json==6.281.22341"],
    license='MPL 2.0',
